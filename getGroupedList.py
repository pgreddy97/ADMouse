...
def generateLabels(motifLists):
	os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/labels/run')
	...
	os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/labels/motif')
	for i in range(0,len(motifLists)):
		newFile=open(chooseName(str(i))+'_numbers.txt','w')
		newFile.write('names'+'\n')
		line =''
...
def generateUpdLists(motifLists):
	for i in range(0,len(motifLists)):
		os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/orderedMatrices')
...
def importOrders(runOrders, motifOrders):
	os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/orders')
