...
def generateLabels(motifLists):
	os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/noNone/labels/run')
	...
	os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/noNone/labels/motif')
	for i in range(0,len(motifLists)):
		newFile=open(chooseName(str(i))+'_numbers.txt','w')
		newFile.write('names'+'\n')
		line =''
...
def generateUpdLists(motifLists):
	for i in range(0,len(motifLists)):
		os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/noNone/orderedMatrices')
	...
	for i in range(0,len(motifLists)):
		os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/noNone/orderedMatricesNumbers')
		newFile = open(chooseName(str(i)) + '_numbers.txt','w')
...
def importOrders(runOrders, motifOrders):
	os.chdir('/Users/pranav/Desktop/ScienceResearch/matrices/noNone/orders')
...
def generateSpecificMatrix(site, mark, motifList):
	...
	for run in os.listdir(os.getcwd()):
		if (run!='.DS_Store' and run.find('name')==-1):
