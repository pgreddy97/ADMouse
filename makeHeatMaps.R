...
setwd("/Users/pranav/Desktop/ScienceResearch/matrices/orderedMatricesNumbers")
print(dir())
col_breaks=c(0,10,20,30,40,50,60,70)
files <- list.files(path="/Users/pranav/Desktop/ScienceResearch/matrices/orderedMatricesNumbers", full.names = FALSE)
...
for (fileName in files) {
    ...
    setwd("/Users/pranav/Desktop/ScienceResearch/matrices/labels/motif")
    motifLabel<- read.table(fileName, header=TRUE, sep="\t")
    setwd("/Users/pranav/Desktop/ScienceResearch/matrices/labels/run")
    runLabel<-read.table(fileName,header=TRUE, sep="\t")
    
    setwd("/Users/pranav/Desktop/ScienceResearch/matrices/heatmaps")
    plot.heatmap(temp, 
                 to.file=name, 
                 row.title="Motifs",
                 col.title="Run",
